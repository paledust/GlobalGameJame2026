...
[Header("Clickable Basic")]
    ...
    public bool m_interactable{get{return gameObject.activeInHierarchy && !isFrozen && hitbox.enabled;}}
...
#region Interaction Function
    ...
    public virtual void OnInteract(PlayerController player, Vector3 hitPos){
    ...
    public virtual void OnFailInteract(PlayerController player){}
...
#region Interaction Activation
    ...
    public void FreezeInteraction(){
        if(m_interactable) OnBecomeUninteractable();
        isFrozen = true;
    }
